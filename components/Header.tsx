      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            <span className="text-xl font-bold text-gray-900">LogoMaster AI</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/hermetic" className="text-gray-700 hover:text-primary-600 transition-colors font-medium">
              Générateur
            </Link>
            <Link href="/gallery" className="text-gray-700 hover:text-primary-600 transition-colors font-medium">
              Galerie
            </Link>
